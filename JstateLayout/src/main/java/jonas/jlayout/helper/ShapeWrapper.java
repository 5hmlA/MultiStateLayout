 ...
 * </pre>
 */
public class ShapeWrapper extends JViewWrapper {
	...
	public static ShapeWrapper wrapper(IForwardDraw view, Context context, AttributeSet attrs, int defStyleAttr) {
...
//		a.recycle();
	...
	@Override public void wrapperDraw(Canvas canvas) {
		...
		//setBounds 否则无法绘制出mViewBackground，mViewBackground.draw无效
	...
	private void shapeByBitmapShader(Canvas canvas) {
		//setLayerType(LAYER_TYPE_SOFTWARE, null); //关闭硬件加速 会导致 出现黑色背景、、 当控件设置了背景之后 会导致被剪切之外的区域有黑色背景，没设置背景不会出现黑边
