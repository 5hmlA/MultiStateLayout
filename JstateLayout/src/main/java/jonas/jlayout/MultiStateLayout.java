...
public class MultiStateLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params){
        ...
        System.out.println("=============");
        if(child.getTag() != null && "top".equals(child.getTag())) {
            mTopViews.add(child);
        }
        for(View topView : mTopViews) {
    ...
    private synchronized MultiStateLayout showStateLayout2(@LayoutState int state){
        ...
        if(mLayoutState == STATE_LOADING) {
            ...
            if(mLoadingLayout != null) {
                ...
                if(( mLoadingLayoutTips = mLoadingLayout
                        .findViewById(R.id.j_multity_loading_msg) ) != null && !TextUtils.isEmpty(mLoadingTips)) {
            ...
            if(mEmptyLayout == null) {
                ...
                if(mEmptyLayout != null) {
                    ...
                    if(( mEmptyLayoutTips = mEmptyLayout.findViewById(R.id.j_multity_empt_msg) ) != null && !TextUtils
                            .isEmpty(mEmptyTips)) {
            ...
            if(mErrorLayout == null) {
                ...
                if(mErrorLayout != null) {
                    ...
                    if(( mErrorLayoutTips = mErrorLayout.findViewById(R.id.j_multity_error_msg) ) != null && !TextUtils
                            .isEmpty(mErrorTips)) {
    ...
    public MultiStateLayout registStateLayout(@LayoutRes int layutID, @LayoutState int state){
        if(state == STATE_EMPTY) {
            ...
            if(mLayoutState == STATE_LOADING) {
                ...
                CustomStateLayout(LayoutInflater.from(getContext()).inflate(layout_loading_resid, this, false), state,
                        true);
            }
        }
        return this;
    ...
    public static int dp2px(float dpVal){
        return (int)TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpVal, Resources.getSystem().getDisplayMetrics());
    }

    public static int sp2px(float dpVal){
        return (int)TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_SP, dpVal, Resources.getSystem().getDisplayMetrics());
    }
